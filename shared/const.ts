...
// `state` carries the callback redirect URI (used at token exchange), a CSRF
// nonce and an allowlisted post-login return URL. Defined here so all OAuth
// entry points and the callback use one compatible contract.
